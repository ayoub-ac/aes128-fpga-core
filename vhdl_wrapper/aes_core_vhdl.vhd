...
--
-- VHDL-2008 wrapper for the SystemVerilog aes_core module.
--
-- This entity exposes the AES-128 core's port list in VHDL syntax. The
...
--
-- I/O contract: identical to aes_core.sv (see PORT_DESCRIPTION.md).
--   * Single clock, active-low synchronous reset.
--   * Valid/ready handshake on both input and output sides.
--   * 128-bit key, 128-bit data, encrypt/decrypt mode select.

library ieee;
  use ieee.std_logic_1164.all;
  use ieee.numeric_std.all;

entity aes_core_vhdl is
  port (
    clk_i     : in  std_logic;
    rst_ni    : in  std_logic;
...
end entity aes_core_vhdl;

architecture rtl of aes_core_vhdl is
